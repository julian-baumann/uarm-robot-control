...
// Resetting position
await connection.Execute(new MovePolar(Stretch: 100, Rotation: 0, Height: 80, Speed: 10));

Thread.Sleep(3000);
await connection.Execute(new MovePolar(Stretch: 200, Rotation: 100, Height: 80, Speed: 10));

Thread.Sleep(1000);
await connection.Execute(new MovePolar(Stretch: 200, Rotation: 100, Height: 200, Speed: 10));
...
Thread.Sleep(200);
await connection.Execute(new MovePolar(Stretch: 200, Rotation: 100, Height: 250, Speed: 10));
